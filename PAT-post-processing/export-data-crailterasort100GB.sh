...
FILE="crailterasort100GB-results-master1.csv"
touch $FILE

for disk_stat_name in ~/PAT/PAT-collecting-data/results/crailterasort100GB/disk_stats/disk-avg-stats-*
do
   ...
   numeric_regex='^[0-9]+$'
       ...
       echo -n "'crailterasort100GB', $num_cores, $ram, $disk1, $disk2, " >> $FILE
       echo -n ", , , , , , , , , , , ," >> $FILE
       if [ "$disk1" = "$disk2" ]; then
