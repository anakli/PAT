...
FILE="SQLequijoin16Mrows-4node-results-master4.csv"
touch $FILE

for disk_stat_name in ~/PAT/PAT-collecting-data/results/SQLequijoin16Mrows-4node/disk_stats/disk-avg-stats-*
do
   ...
   numeric_regex='^[0-9]+$'
       ...
       echo -n "q160, $num_cores, $ram, $disk1, $disk2, " >> $FILE
       echo -n ", , , , , , , , , , , ," >> $FILE
       if [ "$disk1" = "$disk2" ]; then
