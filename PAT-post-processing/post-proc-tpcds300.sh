...
mkdir -p /home/ubuntu/PAT/PAT-collecting-data/results/tpcds300-$query_name
mkdir -p /home/ubuntu/PAT/PAT-collecting-data/results/tpcds300-$query_name/pdf
mkdir -p /home/ubuntu/PAT/PAT-collecting-data/results/tpcds300-$query_name/disk_stats
mkdir -p /home/ubuntu/PAT/PAT-collecting-data/results/tpcds300-$query_name/perf
mkdir -p /home/ubuntu/PAT/PAT-collecting-data/results/tpcds300-$query_name/cpu_stats


for test_name in tpcds300-$query_name-*i3.xl*
do
	echo $test_name
...
for test_name in tpcds300-$query_name-*i3.4xl*
do
	echo $test_name
	cd ~/PAT/PAT-post-processing
	if [[ ($test_name == *"HDD"*) || ($test_name == *"hdd"*) ]] ; then
