...
mkdir -p /home/ubuntu/PAT/PAT-collecting-data/results/tpcds-$query_name
...
for test_name in tpcds-$query_name-*i3.xl*S3*
do
	echo $test_name
...
for test_name in tpcds-$query_name-*i3.4xl*S3*
do
	echo $test_name
	cd ~/PAT/PAT-post-processing
	if [[ ($test_name == *"HDD"*) || ($test_name == *"hdd"*) ]] ; then
	...
	cp /home/ubuntu/PAT/PAT-collecting-data/results/$test_name/instruments/disk_avg_stats.csv /home/ubuntu/PAT/PAT-collecting-data/results/$test_name/instruments/disk-avg-stats-$test_name.csv
	cp /home/ubuntu/PAT/PAT-collecting-data/results/$test_name/instruments/perf.csv /home/ubuntu/PAT/PAT-collecting-data/results/$test_name/instruments/perf-$test_name.csv
	cp /home/ubuntu/PAT/PAT-collecting-data/results/$test_name/instruments/PAT-Result.pdf /home/ubuntu/PAT/PAT-collecting-data/results/tpcds-$query_name/pdf/PAT-$test_name-postproc.pdf
	cp /home/ubuntu/PAT/PAT-collecting-data/results/$test_name/instruments/disk_avg_stats.csv /home/ubuntu/PAT/PAT-collecting-data/results/tpcds-$query_name/disk_stats/disk-avg-stats-$test_name.csv
	cp /home/ubuntu/PAT/PAT-collecting-data/results/$test_name/instruments/perf.csv /home/ubuntu/PAT/PAT-collecting-data/results/tpcds-$query_name/perf/perf-$test_name.csv
	cp /home/ubuntu/PAT/PAT-collecting-data/results/$test_name/instruments/cpu_stats.csv /home/ubuntu/PAT/PAT-collecting-data/results/tpcds-$query_name/cpu_stats/cpu-$test_name.csv
